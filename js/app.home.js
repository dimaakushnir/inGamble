document.addEventListener("DOMContentLoaded", function () {
    $(document).ready(function () {
        ...
        if (document.querySelector('.popular-free-gamble__swiper')) {
            // Popular Free Slider
            const swiperPopularFree = new Swiper('.popular-free-gamble__swiper', {
                // slidesPerView: 5,
                slidesPerView: 'auto',
                spaceBetween: 20,

                pagination: {
                    el: ".popular-free-gamble__pagination",
                    clickable: true,
                },
        ...
        if (document.querySelector('.weeks-favoirites-bonuses-gamble__swiper')) {
            // Week’s Favoirites Bonuses Slider
            const swiperWeeksFavoiritesBonuses = new Swiper('.weeks-favoirites-bonuses-gamble__swiper', {
                // slidesPerView: 5,
                slidesPerView: 'auto',
                spaceBetween: 20,

                pagination: {
                    el: ".weeks-favoirites-bonuses-gamble__pagination",
                    clickable: true,
                },
        ...
        if (document.querySelector('.highroller-casino-bonuses-gamble__swiper')) {
            // Highroller Casino Bonuses Slider
            const swiperHighrollerCasinoBonuses = new Swiper('.highroller-casino-bonuses-gamble__swiper', {
                // slidesPerView: 5,
                slidesPerView: 'auto',
                spaceBetween: 20,

                pagination: {
                    el: ".highroller-casino-bonuses-gamble__pagination",
                    clickable: true,
                },
        ...
        if (document.querySelector('.great-live-casino-bonuses-gamble__swiper')) {
            // Great Live Casino Bonuses Slider
            const swiperGreatLiveCasinoBonuses = new Swiper('.great-live-casino-bonuses-gamble__swiper', {
                // slidesPerView: 5,
                slidesPerView: 'auto',
                spaceBetween: 20,

                pagination: {
                    el: ".great-live-casino-bonuses-gamble__pagination",
                    clickable: true,
                },
        ...
        if (document.querySelector('.top-reload-bonuses__swiper')) {
            // Top Reload Bonuses Slider
            const swiperTopReloadBonuses = new Swiper('.top-reload-bonuses__swiper', {
                // slidesPerView: 5,
                slidesPerView: 'auto',
                spaceBetween: 20,

                pagination: {
                    el: ".top-reload-bonuses__pagination",
                    clickable: true,
                },
        ...
        if (document.querySelector('.playing-now-gamble-mobile__swiper')) {
            // Playing Now Mobile Slider
            const swiperPlayingNowMobile = new Swiper('.playing-now-gamble-mobile__swiper', {
                // slidesPerView: 5,
                slidesPerView: "auto",
                spaceBetween: 20,

                pagination: {
                    el: ".playing-now-gamble-mobile__pagination",
                    clickable: true,
                },
        ...
        //                         const parentElement = document.querySelector('.slider-best-casinos-2024-gamble');
        // 
        //                         // Перевіряємо перший параметр translate3d (по осі X)
        //                         if (translate !== 0) {
        //                             parentElement.classList.add('scrolled'); // Додаємо клас, якщо є скрол
        //                         } else {
        //                             parentElement.classList.remove('scrolled'); // Забираємо клас, якщо все по нулях
        //                         }
        //                     }
        //                 }
        //             });
        ...
        if (document.querySelector('.slider-best-live-dealer-casinos-gamble-mobile__swiper')) {
            // Best Live Dealer Casinos Slider
            const swiperBestLiveDealerCasinos = new Swiper('.slider-best-live-dealer-casinos-gamble-mobile__swiper', {
                // Optional parameters
                slidesPerView: "auto",
                allowTouchMove: true,
                spaceBetween: 20,
                ...
                pagination: {
                    el: ".slider-best-live-dealer-casinos-gamble-mobile__pagination",
                    clickable: true,
                },
