...
if (dropdowns) {
    dropdowns.forEach(function (dropdown) {
        ...
        let dropdown_btn_back = dropdown.querySelector('.dropdown-language-header__btn-back');
        ...
        if (dropdown_btn) {
            ...
            if (dropdown_items) {
                dropdown_items.forEach(function (dropdown_item) {
                    dropdown_item.addEventListener('click', function (event) {
                        ...
                        let dropdown_item_text = dropdown_item.querySelector('.list-item-dropdown-language-header__text');

                        if (dropdown_btn) {
                            let dropdown_btn_icon = document.querySelector('.dropdown-language-header__btn-icon');
                            let dropdown_btn_text = document.querySelector('.dropdown-language-header__btn-text');
                            ...
                            if (dropdown_item_icon && dropdown_btn_icon) {
                                dropdown_btn_icon.innerHTML = dropdown_item_icon.innerHTML;
                            }

                            if (dropdown_item_text && dropdown_btn_text) {
                                dropdown_btn_text.innerHTML = dropdown_item_text.innerHTML;
                            }
                        }
            ...
            if (dropdown_btn_back) {
                dropdown_btn_back.addEventListener('click', function (event) {
                    event.preventDefault();
...
if (form_inputs) {
    form_inputs.forEach(function (form_input) {
        ...
        form_input.addEventListener('blur', function (event) {
            ...
            if (document.querySelector('.form-header__icon')) {
                document.querySelector('.form-header__icon').classList.remove('hide');
            }
            if (document.querySelector('.form__header')) {
                document.querySelector('.form__header').classList.remove('show');
            }
    ...
    form_input_delete_icons.forEach(function (form_input_delete_icon) {
        form_input_delete_icon.addEventListener('click', function (event) {
            ...
            if (document.querySelector('.form-header')) {
                document.querySelector('.form-header').classList.remove('show');
            }
            if (document.querySelector('.form-header__icon')) {
                document.querySelector('.form-header__icon').classList.remove('hide');
            }
...
if (filter_open_btn && sidebar_gamble && header && main) {
    filter_open_btn.addEventListener('click', function (event) {
        ...
        if (document.documentElement.clientWidth > 650.98) {
            ...
            // } else if (!sidebar_gamble.classList.contains('active') && !document.querySelector('.mobile-header.active')) {
...
if (filter_open_delete && sidebar_gamble && header) {
    filter_open_delete.addEventListener('click', function (event) {
        ...
        if (!document.querySelector('.mobile-header.active')) {
            body.classList.remove('lock');
        }
        ...
        if (document.querySelector('.title-filters-sidebar-gamble__text')) {
            let title = document.querySelector('.title-filters-sidebar-gamble__text');

            title.classList.remove('selected');
            document.querySelector('.title-filters-sidebar-gamble__text').innerHTML = 'Filters';
        }

        if (document.querySelector('.filter-selected__body')) {
            document.querySelector('.filter-selected__body').classList.remove('active');
        }
    })
}
...
// Form Header
let form_header_icon = document.querySelector('.form-header__icon');
let form_header_item = document.querySelector('.form-item');
let form_header = document.querySelector('.form-header');

if (form_header_icon && form_header) {
    form_header_icon.addEventListener('click', function (event) {
        event.preventDefault();

        form_header_icon.classList.add('hide');
        form_header.classList.add('show');
    })

    document.addEventListener('click', function (event) {
        if (!event.target.closest('.form-header')) {
            form_header_icon.classList.remove('hide');
            form_header.classList.remove('show');
        }
    })
}
...
// Theme Link
let theme_header_link = document.querySelector('.theme-header__link');

if (theme_header_link) {
    theme_header_link.addEventListener('click', function (event) {
        event.preventDefault();

        theme_header_link.classList.toggle('active');
    })
}

// Show Content
let hide_blocks = document.querySelectorAll('.hide-block');

if (hide_blocks) {
    hide_blocks.forEach(function (hide_block) {
        hide_block.addEventListener('click', function (event) {
            event.preventDefault();

            // hide_block.classList.toggle('active');
            hide_block.classList.add('active');
        })
    })
}

// Like Btns
let like_get_bonus_btns = document.querySelectorAll('.like-get-bonus__btn');

if (like_get_bonus_btns) {
    like_get_bonus_btns.forEach(function (like_get_bonus_btn) {
        like_get_bonus_btn.addEventListener('click', function (event) {
            event.preventDefault();

            if (!like_get_bonus_btn.classList.contains('active')) {
                like_get_bonus_btns.forEach(function (btn) {
                    btn.classList.remove('active');
                })

                like_get_bonus_btn.classList.add('active');
            }
        })
    })
}
...
// Form Subscribe
let forms_subscribe = document.querySelectorAll('.form-subscribe');

if (forms_subscribe) {
    forms_subscribe.forEach(function (form_subscribe) {
        form_subscribe.addEventListener('submit', function (event) {
            event.preventDefault();

            let form_btn = form_subscribe.querySelector('.form-subscribe__btn');

            if (form_btn) {
                form_btn.classList.add('active');
                form_btn.textContent = 'Subscribed';
            }
        })
    })
}